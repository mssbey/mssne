...
export const BASKI_MATBAA: ServiceData[] = [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    gallery: [
      { icon: "CreditCard", label: "Siyah Beyaz Kurumsal Kimlik", alt: "Siyah beyaz kurumsal kimlik kartı şablonu", productCode: "1017-55463" },
      { icon: "CreditCard", label: "Modern Profesyonel Kartvizit", alt: "Modern profesyonel kartvizit tasarımı", productCode: "87202-1053" },
      { icon: "CreditCard", label: "Temiz Modern Kartvizit", alt: "Temiz ve modern minimalist kartvizit tasarımı", productCode: "1361-1576" },
      { icon: "CreditCard", label: "Siyah Beyaz Basit Tasarım", alt: "Siyah beyaz sade kartvizit tasarımı", productCode: "1017-37341" },
      { icon: "CreditCard", label: "Profesyonel İş Kimlik Kartı", alt: "Profesyonel modern iş kimlik kartı şablonu", productCode: "1017-25475" },
      { icon: "CreditCard", label: "Düz Tasarım Minimalist", alt: "Düz tasarım minimalist kartvizit", productCode: "23-2150381168" },
      { icon: "CreditCard", label: "Siyah Altın Mermer", alt: "Siyah ve altın mermer dokulu kartvizit", productCode: "1017-26527" },
      { icon: "CreditCard", label: "Siyah Poligonal Kartvizit", alt: "Siyah poligonal kartvizit tasarımı", productCode: "1017-1212" },
      { icon: "Hospital", label: "Klasik Eczane Kartviziti", alt: "Yeşil ve altın detaylı klasik eczane kartviziti şablonu", productCode: "ECZ-1001" },
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    gallery: [
      { icon: "Gift", label: "12'li Pola Kart Magnet", alt: "On iki adet fotoğraf baskılı pola kart buzdolabı magneti" },
