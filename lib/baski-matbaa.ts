...
export const BASKI_MATBAA: ServiceData[] = [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    gallery: [
      ...
      { icon: "CreditCard", label: "Kare Kartvizit", alt: "Lacivert turuncu kare kesim sigorta kartviziti", productCode: "KV-101" },
      { icon: "Hospital", label: "Standart Kartvizit", alt: "Kırmızı beyaz standart eczane kartviziti örneği", productCode: "KV-102" },
      { icon: "Sparkles", label: "Kabartma Laklı Kartvizit", alt: "Altın yaldız logolu kabartma laklı premium kartvizit", productCode: "KV-103" },
      { icon: "Layers3", label: "Sıvama Kartvizit (700gr)", alt: "Yuvarlak köşeli kalın sıvama kartvizit örneği", productCode: "KV-104" },
      { icon: "Magnet", label: "Mıknatıslı Kartvizit", alt: "Buzdolabına yapışan mıknatıslı kartvizit örneği", productCode: "KV-105" },
    ],
    faq: [
  ...
  // ─────────────────────────────────────────────────────────
  {
    ...
    gallery: [
      ...
      { icon: "Hospital", label: "Eczane Reklam Magneti", alt: "Kırmızı beyaz eczane reklam magneti örneği", productCode: "MAG-101" },
      { icon: "Pill", label: "Kapsül Kesim Eczane Magneti", alt: "İlaç kapsülü formunda özel kesim eczane magneti", productCode: "MAG-102" },
      { icon: "UtensilsCrossed", label: "Dönerci Magneti", alt: "Özel kesim dönerci reklam magneti örneği", productCode: "MAG-103" },
      { icon: "Sparkles", label: "Halı Yıkama Magneti", alt: "Maskot formunda özel kesim halı yıkama magnetleri", productCode: "MAG-104" },
      { icon: "Store", label: "Kasap Magnetleri", alt: "Özel kesim kasap reklam magnetleri örnekleri", productCode: "MAG-105" },
      { icon: "Gift", label: "Düğün / Nişan Magnetleri", alt: "Düğün ve nişan hatıra magnetleri örnekleri", productCode: "MAG-106" },
      { icon: "Truck", label: "Araç Kapı Magneti", alt: "Araç kapısına uygulanan büyük boy reklam magneti", productCode: "MAG-107" },
    ],
    faq: [
