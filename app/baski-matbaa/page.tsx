    ...
    <div className="min-h-screen pt-40 pb-24 px-6 bg-[#050505]">
      <div className="max-w-7xl mx-auto">
        <nav className="flex items-center gap-2 text-xs text-white/30 mb-8">
          ...
          <span>/</span>
          <span className="text-white/60">Baskı ve Matbaa</span>
        </nav>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div
              className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity"
              style={{
                background: "radial-gradient(ellipse 80% 60% at 50% 0%, #FF00C818 0%, transparent 70%)",
              }}
            />
            <div
              ...
              style={{ background: "#FF00C814" }}
            >
              💌
            </div>
            <div className="relative">
              <h2 className="text-xl font-black text-white mb-2 tracking-[-0.5px]">Davetiye</h2>
