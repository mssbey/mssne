...
export function AdvantagesSection({ service }: { service: ServiceData }) {
  return (
    <section
      ...
      style={{
        background: `radial-gradient(ellipse 60% 60% at 50% 0%, ${service.color}0d 0%, transparent 60%), #F3EDEA`,
      }}
    >
          ...
          {service.advantages.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                className="p-6 rounded-2xl border border-black/8 bg-[#FFFFFF]/80 backdrop-blur-sm hover:border-black/15 transition-all"
              >
